...
<p align="center">
  <img src="img/plot__adjacency.png" width="450"><br>
  <em>Adjacency matrix showing φ→φ relational structure. Lower-triangular dominance indicating acyclic ordering.</em>
</p>
<p align="center">
  <img src="img/plot_entropy_hist.png" width="450"><br>
  <em>Entropy histogram tightly centered around ln(10), demonstrating balanced uncertainty.</em>
</p>
<p align="center">
  <img src="img/plot_phi_contrib.png" width="450"><br>
  <em>φ contribution bar chart - top and bottom φ indices contribute symmetrically, showing distributed reasoning.</em>
</p>
<p align="center">
  <img src="img/plot_accuracy.png" width="450"><br>
  <em>Accuracy curves - train vs. validation accuracy per epoch to spot learning progress, overfitting, and early stopping </em>
</p>
